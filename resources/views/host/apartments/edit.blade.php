...
<section class="create-edit container pt-5">
  ...
  {{-- Form --}}
  <form action="{{ route('host.apartments.update', $apartment->id) }}"  enctype="multipart/form-data" method="POST">
    @csrf
    @method('PUT')
    ...
    <div class="btn-create-edit">
      ...
      <button class="btn btn-create ms-2" type="submit">Aggiorna</button>
      <button class="btn btn-create ms-2" type="submit">Sponsor</button>
    </div>
