                    ...
                    <div class="carousel_apratments_swiper mt-150">
                        <div class="blog-slider">
                            <div class="blog-slider__wrp swiper-wrapper">
                                ...
                                @if(count($highlightedApartments) < 3) @foreach($highlightedApartments as $highlightedApartment) <div class="blog-slider__item swiper-slide">
                            ...
                            @endforeach
                            @else
                            @for($i = 0; $i <= 3; $i++) <div class="blog-slider__item swiper-slide">
                                <div class="blog-slider__img">
