                      ...
                      <div class="center-wrap">
                        <div class="section text-center">
                          ...
                          <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group mt-2 text-start">
                              <input id="img_profile" type="file" class="form-control w-100 text-start @error('img_profile') is-invalid @enderror" name="img_profile" value="{{ old('img_profile') }}" required autofocus>
                              <i class="input-icon uil uil-user"></i>
